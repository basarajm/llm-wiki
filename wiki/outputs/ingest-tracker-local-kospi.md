...
- 아카이브 회사 수: **820건** (source_documents/AnnualReport_MD/, 각 머신에 로컬 배치 필요·git 미포함)
- 완료(done, Full): **782건**
- 대기(pending): **38건** (이 중 stub→Full 승급 대상 5건)
...
- 하이비젼시스템 (`KOSPI`) — `source_documents/AnnualReport_MD/하이비젼시스템-사업보고서-2025.12.md`
- 한국기업평가 (`KOSPI`) — `source_documents/AnnualReport_MD/한국기업평가-사업보고서-2025.12.md`
